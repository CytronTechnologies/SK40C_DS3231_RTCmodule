	...
	; Compiler options:
	;
	; -oDS3231(PIC16F887).cof -mDS3231(PIC16F887).map --summary=default \
	; --output=default ds3231.p1 i2c.p1 i2c_rtc.p1 lcd.p1 --chip=16F887 -P \
	; --runtime=default --opt=default,+asm,-debug,-speed,+space,9 --warn=0 \
	; -D__DEBUG=1 --addrqual=ignore -g --asmlist \
